...
// Blocks to catch(in fact it's to avoid...)

class Catches : public GameObject
{
public:
    Catches(const std::string name, Renderer* renderer, std::string tex = "Greentex.png") : GameObject(name, renderer, tex) {
